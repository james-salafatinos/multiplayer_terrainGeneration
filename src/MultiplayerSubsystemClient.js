class MultiplayerSubsystemClient {
  constructor(io) {
    ...
    this.gameParamState = null;
    this.LastGameParamState = null;
    ...
    this.socket.on(
      "guiParamStateFromServer",
      // When we receive data
      function (data) {
        parent.LastGameParamState = parent.gameState;
        parent.gameParamState = data.undefined;
        console.log(
          "guiParam Data From Server Received:",
          parent.gameParamState
        );
      }
    );
